...
public class TestRandom {
	...
	/**
	 * Test for test dices value, need to be between 2 and 12 at max. test for
	 * dices 0, 1 and 13
	 */
	@Test
	...
	/**
	 * Test for player to buy a property on position 1.
	 */
	@Test
	...
	/**
	 * Test if player goes to jail
	 */
	@Test
	public void testGoToJail() {
		do {
			game.updatePlayer(players.get(0));
		} while (players.get(0).getPos().getPos() != 30);
	...
	/**
	 * Test if player can create an house without having all properties of the
	 * group
	 */
	@Test
