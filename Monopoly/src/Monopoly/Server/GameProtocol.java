...
public class GameProtocol {
	...
	public void gameLogic(int index) {
		if (players.get(index).getId() == currentPlayer.getId()) {
			if ((currentPosition == finalPosition) && !positionSold) {
				...
				if (currentPlayer.getPos() instanceof ChanceBox || currentPlayer.getPos() instanceof CommunityBox
						|| currentPlayer.getPos() instanceof GoJailBox
						|| (currentPlayer.getPos() instanceof JailBox && currentPlayer.getInJail())) {
